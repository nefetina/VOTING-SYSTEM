        ...
        <section>
            ...
            <div class="btns">
                <div class="bttn">
                    ...
                    <button id="b" onclick="document.location='application.html'">FILE CANDIDACY</button>
                </div>
                <div class="bttn">
                    <button id="b" onclick="document.location='result.html'">VIEW RESULTS</button>
                    <button id="b" onclick="document.location='index.html'">LOG OUT</button>
                </div>
            </div>
